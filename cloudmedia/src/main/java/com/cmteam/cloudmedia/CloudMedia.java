...
public class CloudMedia {
     ...
     * Return: the node id generated by the server, null if login is failed.
     */
    public String login(final String domainName, final String account, final String passwd) {
    ...
    public boolean logout(final String account, final String nodeID) {
        return mLoginManager.logout(account, nodeID);
    }

    /**
     * Get user info associate with the node which is logged in
     */
    public CMUser getUser(final String nodeID) {
        return mLoginManager.getUser(nodeID);
    }
